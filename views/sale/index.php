...
<div class="bg" style="background-image: url(/template/img/sale.jpg); background-repeat: no-repeat; background-size: cover;">
...
<main class="pb-5"> <br><br><br><br><br>
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5">Скидки</h2>
      ...
      <div class="card card-image overlay" style="background-image: url(<?php echo Product::getImage($product['id']); ?>); background-repeat: no-repeat; background-size: cover;">
        <a href="/game/<?php echo $product['id'];?>"><div class="text-white text-center align-items-center py-5 px-4 rgba-black-strong rounded waves-effect waves-light mask" style="height: 350px;">
          <div class="">
            ...
            <p class="pb-3 text-center"><h2 class="white-text"><strong><?php if ($product['price']): ?><?php echo $product['price'];?> p.<?php else: ?>Бесплатно<?php endif; ?></strong></h2></p>
            <h3 class="white-text font-weight-bold"><strong><del><?php echo $product['price_sale'];?> p.</del></strong></h3>
            <?php if (User::isGuest()): ?>
              <?php else: ?>
