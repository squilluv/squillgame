...
<div class="bg" style="background-image: url(/template/img/seri.jpg); background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
 ...
 <nav class="mb-5 navbar navbar-expand-lg navbar-dark black center mt-3">
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5">Серии игр</h2>
  <div class="row">
    <?php foreach ($series as $ser): ?>
    <div class="col-sm-12 mb-3 pb-2">
      <div class="card card-image overlay" style="background-image: url(<?php echo Series::getImage($ser['id']); ?>); background-repeat: no-repeat; background-size: cover;">
        <a href="/series/<?php echo $ser['id'];?>"><div class="text-white text-center align-items-center py-5 px-4 rgba-black-strong rounded waves-effect waves-light mask" style="height: 350px;">
          <div class="">
            <h3 class="py-3 font-weight-bold white-text">
              <strong><?php echo $ser['name'];?></strong>
            </h3>
          </div>
        </div></a>
      </div>
