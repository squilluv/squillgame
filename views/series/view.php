...
<head>
  ...
  <title><?php foreach ($series as $rec): ?><?php if ($seriesId == $rec['id']) echo $rec['name']; ?><?php endforeach; ?></title>
...
<div class="bg" style="background-image: url(<?php echo series::getImage($seriesId); ?>);  background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5">Серия игр <?php foreach ($series as $rec): ?><?php if ($seriesId == $rec['id']) echo $rec['name']; ?><?php endforeach; ?></h2>
  <div class="row">
    <?php foreach ($seriesProducts as $product): ?>
    <div class="col-md-3 mb-3 pb-2">
      <div class="card card-image overlay" style="background-image: url(<?php echo Product::getImage($product['id']); ?>); background-repeat: no-repeat; background-size: cover;">
        <a href="/game/<?php echo $product['id'];?>"><div class="text-white text-center align-items-center py-5 px-4 rgba-black-strong rounded waves-effect waves-light mask" style="height: 350px;">
          <div class="">
            <h4 class="py-3 font-weight-bold white-text">
