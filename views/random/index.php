  ...
  <div class="collapse navbar-collapse" id="basicExampleNav">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-black black" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item-black white-text" href="/catalog">Каталог игр</a>
          <!-- <a class="dropdown-item-black white-text" href="/tegs">Метки &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
          <a class="dropdown-item-black white-text" href="/others"> Другое</a> -->
        </div>
      </li>
      <li class="nav-item">
...
<div class="bg" style="background-image: url(/template/img/rand.jpg); background-repeat: no-repeat; background-size: cover;">
...
<main class="pb-5"> <br><br><br><br><br>
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5">Не можете выбрать игру?</h2>
  
<section class="text-center wow fadeIn">
  <div class="row">
    <?php foreach ($randomProduct as $product): ?>
    <div class="col-md-12 mb-3 pb-2 my-5">
      <div class="card card-image overlay" style="background-image: url(<?php echo Product::getImageRec($product['id']); ?>); background-repeat: no-repeat; background-size: cover;">
        <a href="/game/<?php echo $product['id'];?>"><div class="text-white text-center align-items-center py-5 px-4 rgba-black-strong rounded waves-effect waves-light " style="height: 500px;">
          <div class="view zoom mt-5">
            <h1 class="py-3 font-weight-bold white-text">
