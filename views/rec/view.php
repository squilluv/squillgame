...
<head>
  ...
  <title><?php foreach ($recs as $rec): ?><?php if ($recId == $rec['id']) echo $rec['name']; ?><?php endforeach; ?></title>
...
<div class="bg" style="background-image: url(<?php echo Recomended::getImage($recId); ?>);  background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5"><?php foreach ($recs as $rec): ?><?php if ($recId == $rec['id']) echo $rec['name']; ?><?php endforeach; ?></h2>
  <div class="row">
