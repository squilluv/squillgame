...
<div class="bg" style="background-image: url(/template/img/preorder.jpg); background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
...
<main class="pb-5"> <br><br><br><br><br>
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5">Предзаказ</h2>
  
<section class="text-center wow fadeIn">
  <div class="row">
    <?php foreach ($preProducts as $product): ?>
