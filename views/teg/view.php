...
<head>
  ...
  <title><?php foreach ($tegs as $teg): ?><?php if ($tegId == $teg['id']) echo $teg['name']; ?><?php endforeach; ?></title>
...
<div class="bg" style="background-image: url(/template/img/teg.jpg); background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5"><?php foreach ($tegs as $teg): ?><?php if ($tegId == $teg['id']) echo $teg['name']; ?><?php endforeach; ?></h2>
  <div class="row">
    <?php foreach ($tegProducts as $product): ?>
