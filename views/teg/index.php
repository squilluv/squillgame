...
<div class="bg" style="background-image: url(/template/img/fon.jpg);">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 mb-3 pb-2">
      <div class="card card-image overlay" style="background-image: url(<?php echo Teg::getImage($teg['id']); ?>); background-repeat: no-repeat; background-size: cover;">
        <a href="/teg/<?php echo $teg['id'];?>"><div class="text-white text-center align-items-center py-5 px-4 rgba-black-strong rounded waves-effect waves-light mask" style="height: 350px;">
          <div class="">
            <h3 class="py-3 font-weight-bold white-text">
              <strong><?php echo $teg['name'];?></strong>
            </h3>
          </div>
        </div></a>
      </div>
