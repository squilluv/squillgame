...
<head>
  ...
  <title><?php foreach ($categories as $categoryItem): ?><?php if ($categoryId == $categoryItem['id']) echo $categoryItem['name']; ?><?php endforeach; ?></title>
...
<div class="bg" style="background-image: url(/template/img/category.jpg); background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5"><?php foreach ($categories as $categoryItem): ?><?php if ($categoryId == $categoryItem['id']) echo $categoryItem['name']; ?><?php endforeach; ?></h2>
  <div class="row">
