...
<div class="bg" style="background-image: url(/template/img/837247.jpg); background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
...
<div class="row">
  ...
  <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
    <div class="avatar mx-auto">
      <a href="/user/<?php echo $user['id']; ?>"><img src="<?php echo User::getImage($user['id']); ?>" class="rounded-circle z-depth-1"
        alt="Sample avatar" style="width: 200px;"></a>
    </div>
    <a href="/user/<?php echo $user['id']; ?>"><h5 class="font-weight-bold mt-4 mb-3"><?php echo $user['name']; ?></h5></a>
