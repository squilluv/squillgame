...
<header>
  ...
  <!-- Navbar -->
  <!-- Full Page Intro -->
  <div class="view" style="background-image: url('/template/img/log.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
	...
	<div class="container">
		<div class="row my-3">
			...
			<div class="col-md-6 ">
					...
					<h1 class="black-text text-center mt-5"><strong><b>Вход</b></strong></h1><br>
          <?php if (isset($errors) && is_array($errors)): ?>
          <ul>
            <?php foreach ($errors as $error): ?>
              <li> <h6 class="black-text text-center"><?php echo $error; ?></h6></li>
            <?php endforeach; ?>
          </ul>
        <?php endif; ?>
					<form action="" method="post" class="text-center ">
            <div class="md-form white">
						<input type="email" name="email" placeholder="E-mail" id="defaultLoginFormPassword" class="form-control mt-1" value="<?php echo $email; ?>">
            </div>
            <div class="md-form white">
						<input type="password" name="password" placeholder="Пароль" id="defaultLoginFormPassword" class="form-control mt-1" value="<?php echo $password; ?>">
            </div>
            
						<input class="btn btn-black btn-rounded" type="submit" name="submit" value="Вход">

						<br><br>
					
					</form>
				<h3><div class="text-center"></d><a class="nav-link black-text" href="/user/register"><strong><b>Я не зарегестрирован</b></strong></a></div></h3>
			</div>
			<div class="col">
