...
<div class="bg" style="background-image: url('/template/img/like.jpg'); background-repeat: repeat-y, repeat-y; background-position: left, right; background-attachment: fixed, fixed; background-size: cover;">
  ...
  <h2 class="h1-responsive font-weight-bold text-center my-5">Понравившиеся вам игры</h2>
  <div class="row">
    <?php foreach ($likeList as $product): ?>
